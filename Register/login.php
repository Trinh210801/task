...
if (isset($_POST['dangnhap'])) 
{
    ...
    $query = mysqli_query($conn,"
        SELECT username,password FROM information_user WHERE username='$username' and password='$password'
        ");
    ...
    echo "Xin chào " . $username . ". Bạn đã đăng nhập thành công. <a href='login.php'>Trở lại</a>";;
    die();
}
?>
<!DOCTYPE html>
